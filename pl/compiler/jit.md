# XCX Tracing JIT (Cranelift) — Dokumentacja

> **Plik:** `src/backend/jit.rs`  
> XCX 3.0 zawiera **dwutrybowy JIT**, który automatycznie kompiluje zarówno gorące pętle, jak i często wywoływane funkcje do natywnego kodu maszynowego przy użyciu frameworka [Cranelift](https://github.com/bytecodealliance/wasmtime/tree/main/cranelift).
...
1. [Przegląd](#przegląd)
2. [Dwa tryby JIT](#dwa-tryby-jit)
3. [Tracing JIT — wykrywanie gorących pętli](#tracing-jit--wykrywanie-gorących-pętli)
4. [Nagrywanie trace](#nagrywanie-trace)
5. [Kompilacja trace](#kompilacja-trace)
6. [Wykonanie trace](#wykonanie-trace)
7. [Method JIT — kompilacja funkcji](#method-jit--kompilacja-funkcji)
8. [Warianty TraceOp](#warianty-traceop)
9. [Eksportowane funkcje C](#eksportowane-funkcje-c)
10. [Konfiguracja JIT](#konfiguracja-jit)

---

## Przegląd

JIT jest **całkowicie przezroczysty** dla programisty — aktywuje się automatycznie i wraca do interpretera po trafieniu na strażniki typów lub nieobsługiwane operacje.

Istnieją dwie niezależne ścieżki kompilacji:
...
## Tracing JIT — wykrywanie gorących pętli
