# Referencja języka XCX — v3.0

> Kompletna referencja składni i semantyki języka XCX.

---

## Spis treści

1. [Typy danych](#typy-danych)
2. [Zmienne i stałe](#zmienne-i-stałe)
3. [Operatory](#operatory)
4. [Przepływ sterowania](#przepływ-sterowania)
5. [Funkcje](#funkcje)
6. [Włókna (korutyny)](#włókna-korutyny)
7. [Kolekcje](#kolekcje)
8. [JSON](#json)
9. [Tabele](#tabele)
10. [Baza danych (SQLite)](#baza-danych-sqlite)
11. [Sieć (HTTP)](#sieć-http)
12. [Magazyn (pliki)](#magazyn-pliki)
13. [Terminal](#terminal)
14. [Data i czas](#data-i-czas)
15. [Losowość](#losowość)
16. [Kryptografia](#kryptografia)
17. [Diagnostyka i halt](#diagnostyka-i-halt)
18. [Include](#include)
...
| Typ XCX | Opis | Przykład |
|---|---|---|
| `i` | 48-bitowa liczba całkowita | `i: age = 25;` |
| `f` | 64-bitowy float | `f: pi = 3.14;` |
| `s` | Łańcuch UTF-8 | `s: name = "Alice";` |
| `b` | Wartość logiczna | `b: flag = true;` |
| `date` | Data/czas (ms) | `date: d = date("2024-01-01");` |
| `json` | Dowolny JSON | `json: data = <<<{}>>>;` |
| `array:T` | Typowana tablica | `array:i nums = [1, 2, 3];` |
| `set:N/Q/Z/S/C/B` | Zbiór | `set:N mySet = set:N { 1,,100 };` |
| `map:K<->V` | Mapa | `map:s<->i scores = ["Alice" :: 100];` |
| `table` | Tabela relacyjna | `table: ...` |
| `fiber:T` | Korutyna | `fiber:i f = myFiber(10);` |
| `database` | Połączenie SQLite | `database: db = database { ... };` |
